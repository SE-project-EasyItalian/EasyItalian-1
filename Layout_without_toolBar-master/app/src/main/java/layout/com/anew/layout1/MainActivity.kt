...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.nav_new_word -> {
                val changeToNew_words = Intent()
                changeToNew_words.setClass(this, NewWords::class.java)
                startActivity(changeToNew_words)
                Toast.makeText(this,"call new word activity",Toast.LENGTH_SHORT).show()
            }
        }
