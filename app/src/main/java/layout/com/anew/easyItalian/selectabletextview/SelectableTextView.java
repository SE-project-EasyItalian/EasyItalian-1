package layout.com.anew.easyItalian.selectabletextview;
...
import layout.com.anew.easyItalian.selectabletextview.WordInfo;
 ...
 * Created by Brioal on 3/17/2018.
 */
...
public class SelectableTextView extends android.support.v7.widget.AppCompatTextView {
    ...
    public void setText(CharSequence text, BufferType type) {
        ...
        if (isEnableSingleSelect) {
            ...
            // 分割单词
            List<layout.com.anew.easyItalian.selectabletextview.WordInfo> wordInfos = getWordInfo();
            // 设置点击事件
            for (int i = 0; i < wordInfos.size(); i++) {
                layout.com.anew.easyItalian.selectabletextview.WordInfo info = wordInfos.get(i);
     ...
     * @return
     */
    private List<layout.com.anew.easyItalian.selectabletextview.WordInfo> getWordInfo() {
        // 获取分割之后的所有单词
        List<String> words = splitWord();
        // 创建WordInfos
        List<layout.com.anew.easyItalian.selectabletextview.WordInfo> result = new ArrayList<>();
        int startIndex = 0;
        for (int i = 0; i < words.size(); i++) {
            ...
            startIndex = end;
            layout.com.anew.easyItalian.selectabletextview.WordInfo wordInfo = new WordInfo();
